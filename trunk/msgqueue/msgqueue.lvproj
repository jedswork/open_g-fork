	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="source" Type="Folder">
			<Item Name="examples" Type="Folder">
				<Item Name="Message and Response Example.vi" Type="VI" URL="../source/examples/Message and Response Example.vi"/>
			</Item>
			<Item Name="images" Type="Folder">
				<Item Name="classic.png" Type="Document" URL="../source/images/classic.png"/>
				<Item Name="icon.png" Type="Document" URL="../source/images/icon.png"/>
			</Item>
			<Item Name="install scripts" Type="Folder"/>
			<Item Name="library" Type="Folder">
				<Item Name="Cast Msg Queue to Queue.vi" Type="VI" URL="../source/library/Cast Msg Queue to Queue.vi"/>
				<Item Name="Cast Msg to Msg Cluster.vi" Type="VI" URL="../source/library/Cast Msg to Msg Cluster.vi"/>
				<Item Name="Cast Msgs to Msg Clusters.vi" Type="VI" URL="../source/library/Cast Msgs to Msg Clusters.vi"/>
				<Item Name="Cast Queue to Msg Queue.vi" Type="VI" URL="../source/library/Cast Queue to Msg Queue.vi"/>
				<Item Name="Create Msg Queue.vi" Type="VI" URL="../source/library/Create Msg Queue.vi"/>
				<Item Name="Default Message Cluster.vi" Type="VI" URL="../source/library/Default Message Cluster.vi"/>
				<Item Name="Destroy Msg Queue.vi" Type="VI" URL="../source/library/Destroy Msg Queue.vi"/>
				<Item Name="Flush Msg Queue.vi" Type="VI" URL="../source/library/Flush Msg Queue.vi"/>
				<Item Name="Get Msg Queue Status.vi" Type="VI" URL="../source/library/Get Msg Queue Status.vi"/>
				<Item Name="Insert Msg Queue Element.vi" Type="VI" URL="../source/library/Insert Msg Queue Element.vi"/>
				<Item Name="Msg Cluster.ctl" Type="VI" URL="../source/library/Msg Cluster.ctl"/>
				<Item Name="Msg Queue RefNum.ctl" Type="VI" URL="../source/library/Msg Queue RefNum.ctl"/>
				<Item Name="Not A Msg Queue.vi" Type="VI" URL="../source/library/Not A Msg Queue.vi"/>
				<Item Name="Remove Msg Queue Element.vi" Type="VI" URL="../source/library/Remove Msg Queue Element.vi"/>
				<Item Name="VI Tree - Msg Queue.vi" Type="VI" URL="../source/library/VI Tree - Msg Queue.vi"/>
			</Item>
		...
		<Item Name="tests" Type="Folder">
			...
			<Item Name="TEST - Create Msg Queue.vi" Type="VI" URL="../tests/TEST - Create Msg Queue.vi"/>
			<Item Name="TEST - Destroy Msg Queue.vi" Type="VI" URL="../tests/TEST - Destroy Msg Queue.vi"/>
			<Item Name="TEST - Flush Msg Queue.vi" Type="VI" URL="../tests/TEST - Flush Msg Queue.vi"/>
			<Item Name="TEST - Get Msg Queue Status.vi" Type="VI" URL="../tests/TEST - Get Msg Queue Status.vi"/>
			<Item Name="TEST - Insert Msg Queue Element.vi" Type="VI" URL="../tests/TEST - Insert Msg Queue Element.vi"/>
			<Item Name="TEST - Message Queue.vi" Type="VI" URL="../tests/TEST - Message Queue.vi"/>
			<Item Name="TEST - Not A Msg Queue.vi" Type="VI" URL="../tests/TEST - Not A Msg Queue.vi"/>
			<Item Name="TEST - Remove Msg Queue Element.vi" Type="VI" URL="../tests/TEST - Remove Msg Queue Element.vi"/>

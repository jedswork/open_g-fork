...
<Project Type="Project" LVVersion="8208000">
   <Item Name="My Computer" Type="My Computer">
      ...
      <Item Name="OpenG_Value_Object_Template.lvclass" Type="LVClass" URL="source/template/OpenG_Value_Object_Template.lvclass">
         <Item Name="OpenG_Value_Object_Template.ctl" Type="Class Private Data" URL="source/template/OpenG_Value_Object_Template.lvclass/OpenG_Value_Object_Template.ctl"/>
         <Item Name="Definitions" Type="Folder">
            <Item Name="Construction &amp; Destruction" Type="Folder">
               <Item Name="Constructor_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Definitions/Construction_&amp;_Destruction/Constructor_OpenG_Value_Object_Template.vi"/>
            </Item>
            <Item Name="Data" Type="Folder">
               <Item Name="ObjectParameters_OpenG_Value_Object_Template.ctl" Type="VI" URL="source/template/Definitions/Data/ObjectParameters_OpenG_Value_Object_Template.ctl"/>
               <Item Name="ObjectPrivateData_OpenG_Value_Object_Template.ctl" Type="VI" URL="source/template/Definitions/Data/ObjectPrivateData_OpenG_Value_Object_Template.ctl"/>
            </Item>
            <Item Name="Transformations" Type="Folder">
               <Item Name="PrivateDataToXML_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Definitions/Transformations/PrivateDataToXML_OpenG_Value_Object_Template.vi"/>
            </Item>
            <Item Name="Version_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Definitions/Version_OpenG_Value_Object_Template.vi"/>
         </Item>
         <Item Name="Templates" Type="Folder">
            <Item Name="FunctionalClassVariable_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Templates/FunctionalClassVariable_OpenG_Value_Object_Template.vi"/>
            <Item Name="AlternativeCreate_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Templates/AlternativeCreate_OpenG_Value_Object_Template.vi"/>
            <Item Name="GetProperty_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Templates/GetProperty_OpenG_Value_Object_Template.vi"/>
            <Item Name="SetProperty_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Templates/SetProperty_OpenG_Value_Object_Template.vi"/>
            <Item Name="ReadData_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Templates/ReadData_OpenG_Value_Object_Template.vi"/>
            <Item Name="WriteData_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Templates/WriteData_OpenG_Value_Object_Template.vi"/>
            <Item Name="ReadWriteData_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Templates/ReadWriteData_OpenG_Value_Object_Template.vi"/>
            <Item Name="NoneModifing_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Templates/NoneModifing_OpenG_Value_Object_Template.vi"/>
         </Item>
         <Item Name="Internal" Type="Folder">
            <Item Name="Protected" Type="Folder">
         ...
         <Item Name="Create_OpenG_Value_Object_Template.vi" Type="VI" URL="source/template/Create_OpenG_Value_Object_Template.vi"/>
      </Item>
